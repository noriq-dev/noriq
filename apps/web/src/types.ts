...
export type ViewId = 'home' | 'control' | 'graph' | 'executions' | 'intelligence' | 'board' | 'plans' | 'roadmap' | 'review' | 'docs' | 'ask' | 'agents' | 'runs' | 'settings' | 'project-settings' | 'admin' | 'memory' | 'more';
