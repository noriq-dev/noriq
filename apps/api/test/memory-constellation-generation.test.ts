...
import type {
  ConstellationGenerationData, ConstellationGenerationStatus, ProjectMemoryHealth,
...
function generationData(a: string, b: string): ConstellationGenerationData {
  return {
    ...
    communities: [
      { id: 'com_a', parentId: null, level: 0, label: 'A', memberCount: 1, childCount: 0, typeCounts: { task: 1 }, internalWeight: 0, normalizedCohesion: 0, boundaryWeight: 1, anchor: [1, 2, 3] },
      { id: 'com_b', parentId: null, level: 0, label: 'B', memberCount: 1, childCount: 0, typeCounts: { memory: 1 }, internalWeight: 0, normalizedCohesion: 0, boundaryWeight: 1, anchor: [4, 5, 6] },
    ],
    memberships: [
